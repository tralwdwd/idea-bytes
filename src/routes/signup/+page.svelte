...
<h1 class="text-4xl font-bold mb-6 text-center">Create an account to submit new ideas!</h1>
...
<p class="text-center">Alread have an account? <a href="/login" class="text-blue-500">Login</a>.</p>
